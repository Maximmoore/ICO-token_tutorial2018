...
// ------------------------------------
// The contract is compiled by Maxim Moore.
// slavium.xyz
// ------------------------------------
// This contract is free to use for anyone.
// Have fun.
// ====================================
...
// ----------------------------------------------------------------------------
contract Tutorial_nameICO is ERC20Interface, Owned, SafeMath {
    string public symbol;
    string public tokenName;
    string public version = "1.1";
    uint private decimals;
    uint private _totalSupply;
    uint public startOfCrowdsale = 1536005400; // 03.09.2018 08:10 UTC   <-- CHANGE THIS
    ...
    // ------------------------------------------------------------------------
    constructor() public {
        symbol = "ANN"; // <-- CHANGE THIS
        tokenName = "Anyname"; // <-- CHANGE THIS
        ...
        hardCap = 5000 ether; <-- CHANGE THIS
    }
